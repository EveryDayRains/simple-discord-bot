...
default:
         embed.setDescription('Экономика')
        ...
        .addField(`Пример:`, `eco <функция> <пользователь (тег,ид, имя)> <кол-во>`)
        .setColor("#36393f")
...
case "setxp":
    row.xp = args[2]
    row.save();
        embed.setDescription(`Вы успешно установили ${args[2]}xp пользователю ${member.user.tag}`)
        .setColor("#36393f")
        message.channel.send(embed)
        break;
    }
